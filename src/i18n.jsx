  ...
  es: {
    ...
    products: {
      ...
      items: {
        ...
        'h-waffle': { name: "Waffle Bowl", image: "waffle bowl.png", price: 21000, priceStr: "$21.000 COP", desc: "Centro de mesa o frutero minimalista. Su estructura de rejilla aporta un alto contraste visual a cualquier superficie.", size: "10 mm", material: "Filamento PLA Premium", color: "Blanco", weight: "60 g", collection: "hogar" },
        'h-angel': { name: "Escultura Ángel", image: "angel.png", price: 16000, priceStr: "$16.000 COP", desc: "Figura decorativa que aporta protección y calma. Perfecta para cualquier rincón de tu hogar.", size: "85 mm", material: "Filamento PLA", color: "Blanco (Pintado a mano)", weight: "20 g", collection: "hogar" },
        'h-llaves': { name: "Colgador de llaves", image: "home keys.png", price: 16000, priceStr: "$16.000 COP", desc: "Soporte resistente para llaves. La fusión perfecta entre utilidad y diseño moderno.", size: "7.5 mm", material: "Filamento PLA", color: "Negro Matte", weight: "34 g", collection: "hogar" },
        'h-ovejita': { name: "Soporte Ovejita Shaun", image: "shaun the sheep.png", price: 11000, priceStr: "$11.000 COP", desc: "Un toque de humor y orden para el baño. Soporte para papel higiénico que transforma lo cotidiano en algo memorable.", size: "19.1 mm", material: "Filamento PLA", color: "Negro Matte", weight: "11 g", collection: "hogar" },
        'h-osito': { name: "Angel Osito", image: "angel osito.png", price: 18000, priceStr: "$18.000 COP", desc: "Un tierno osito con alas de ángel. Ideal para decorar habitaciones infantiles o como un detalle lleno de ternura.", size: "75 mm", material: "Filamento PLA", color: "Blanco (Pintado a mano)", weight: "22 g", collection: "hogar" },
        'g-spiderman': { name: "Llavero Spiderman", image: "spiderman.png", price: 22000, priceStr: "$22.000 COP", desc: "Llavero inspirado en Spiderman. Un tributo pintado a mano.", size: "4 mm", material: "Filamento PLA", color: "Blanco (Pintado a mano)", weight: "5 g", collection: "geek" },
        'g-gow': { name: "Llavero Espadas GOW", image: "god of war.png", price: 38000, priceStr: "$38.000 COP", desc: "Réplicas milimétricas del mundo de Kratos.", size: "2.6 mm", material: "Filamento PLA", color: "Blanco (Pintado a mano)", weight: "4 g", collection: "geek" },
        'g-jinx': { name: "Bomba Jinx", image: "jinx bomb.png", price: 55000, priceStr: "$55.000 COP", desc: "Caos en la palma de tu mano. Reproducción fiel y detallada pintada a mano para elevar tu setup o llaves.", size: "50 mm", material: "Filamento PLA", color: "Blanco (Pintado a mano)", weight: "7 g", collection: "geek" },
        'g-hollow': { name: "Llavero Hollow Knight", image: "hollow knight.png", price: 32000, priceStr: "$32.000 COP", desc: "El guardián de Hollownest materializado.", size: "49 mm", material: "Filamento PLA", color: "Blanco (Pintado a mano)", weight: "5 g", collection: "geek" },
        'g-dados': { name: "Castillo Torre de Dados", image: "dice tower.png", price: 24000, priceStr: "$24.000 COP", desc: "Estructura funcional para tabletop gaming. Cada lanzamiento de dados se convierte en una experiencia.", size: "178 mm", material: "Filamento PLA", color: "Azul Geométrico", weight: "116 g", collection: "geek" }
      }
    },
    cart: {
      title: "Tu Carrito",
  ...
  en: {
    ...
    products: {
      ...
      items: {
        ...
        'h-latas': { name: "Fridge Can Organizer", image: "can dispenser.jpg", price: 47000, priceStr: "$47,000 COP", desc: "Can dispenser designed to maximize storage space in your refrigerator.", size: "180 mm", material: "Premium PLA Filament", color: "White", weight: "260 g", collection: "hogar" },
        'h-waffle': { name: "Waffle Bowl", image: "waffle bowl.png", price: 21000, priceStr: "$21,000 COP", desc: "A minimalist centerpiece or fruit bowl. Its lattice design adds striking visual contrast to any surface.", size: "10 mm", material: "Premium PLA Filament", color: "White", weight: "60 g", collection: "hogar" },
        'h-angel': { name: "Angel Sculpture", image: "angel.png", price: 16000, priceStr: "$16,000 COP", desc: "A decorative figurine that brings protection and calm. Perfect for any corner of your home.", size: "85 mm", material: "PLA Filament", color: "White (Hand-painted)", weight: "20 g", collection: "hogar" },
        'h-llaves': { name: "Minimal Key Holder", image: "home keys.png", price: 16000, priceStr: "$16,000 COP", desc: "Sturdy key holder. The perfect blend of functionality and modern design.", size: "7.5 mm", material: "PLA Filament", color: "Matte Black", weight: "34 g", collection: "hogar" },
        'h-ovejita': { name: "Shaun the Sheep Holder", image: "shaun the sheep.png", price: 11000, priceStr: "$11,000 COP", desc: "A touch of humor and organization for the bathroom. A toilet paper holder that turns the everyday into something memorable.", size: "19.1 mm", material: "PLA Filament", color: "Matte Black", weight: "11 g", collection: "hogar" },
        'h-osito': { name: "Angel Teddy Bear", image: "angel osito.png", price: 18000, priceStr: "$18,000 COP", desc: "A cute teddy bear with angel wings. Ideal for decorating children's rooms or as a gift full of tenderness.", size: "75 mm", material: "PLA Filament", color: "White (Hand-painted)", weight: "22 g", collection: "hogar" },
        'g-spiderman': { name: "Spiderman Keychain", image: "spiderman.png", price: 22000, priceStr: "$22,000 COP", desc: "Spider-Man-inspired keychain. A hand-painted tribute.", size: "4 mm", material: "PLA Filament", color: "White (Hand-painted)", weight: "5 g", collection: "geek" },
        'g-gow': { name: "GOW Blades Keychain", image: "god of war.png", price: 38000, priceStr: "$38,000 COP", desc: "Life-size replicas of Kratos' world.", size: "2.6 mm", material: "PLA Filament", color: "White (Hand-painted)", weight: "4 g", collection: "geek" },
        'g-jinx': { name: "Jinx Bomb Keychain", image: "jinx bomb.png", price: 55000, priceStr: "$55,000 COP", desc: "Chaos in the palm of your hand. A faithful, detailed hand-painted reproduction to elevate your setup or keys.", size: "50 mm", material: "PLA Filament", color: "White (Hand-painted)", weight: "7 g", collection: "geek" },
        'g-hollow': { name: "Hollow Knight Keychain", image: "hollow knight.png", price: 32000, priceStr: "$32,000 COP", desc: "The guardian of Hollownest materialized.", size: "49 mm", material: "PLA Filament", color: "White (Hand-painted)", weight: "5 g", collection: "geek" },
        'g-dados': { name: "Dice Tower Castle", image: "dice tower.png", price: 24000, priceStr: "$24,000 COP", desc: "A functional framework for tabletop gaming. Every roll of the dice becomes an experience.", size: "178 mm", material: "PLA Filament", color: "Geometric Blue", weight: "116 g", collection: "geek" }
      }
    },
    cart: {
      title: "Your Cart",
