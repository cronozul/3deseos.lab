...
const ProductCard = ({ id, productKey, collectionData }) => {
  ...
  return (
    <Link to={`/products/${productKey}`}>
      ...
      >
        <div className={`absolute inset-0 bg-gradient-to-br ${collectionData.gradient} opacity-40 group-hover:opacity-60 transition-opacity`} />
        ...
        {/* Abstract Product Shape Placeholder */}
