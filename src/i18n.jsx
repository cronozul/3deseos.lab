...
const translations = {
  es: {
    ...
    products: {
      ...
      items: {
        ...
        't-sardinas': { name: "Joyero Sardinas", image: "sardines.png", price: 21000, priceStr: "$21.000 COP", desc: "Protege y exhibe tus joyas con un diseño inspirado en latas de conserva.", size: "26 mm", material: "Filamento PLA", color: "Tornasol y Blanco", weight: "27 g", collection: "tornasol", model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
        'h-latas': { name: "Organizador de latas", image: "can dispenser.jpg", price: 47000, priceStr: "$47.000 COP", desc: "Dispensador de latas diseñado para maximizar el almacenamiento de tu refrigerador.", size: "180 mm", material: "Filamento PLA Premium", color: "Blanco", weight: "260 g", collection: "hogar", model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
        'h-waffle': { name: "Waffle Bowl", image: "waffle bowl.png", price: 21000, priceStr: "$21.000 COP", desc: "Centro de mesa o frutero minimalista. Su estructura de rejilla aporta un alto contraste visual a cualquier superficie.", size: "10 mm", material: "Filamento PLA Premium", color: "Blanco", weight: "60 g", collection: "hogar", model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
        'h-angel': { name: "Escultura Ángel", image: "angel.png", price: 16000, priceStr: "$16.000 COP", desc: "Figura decorativa que aporta protección y calma. Perfecta para cualquier rincón de tu hogar.", size: "85 mm", material: "Filamento PLA", color: "Blanco (Pintado a mano)", weight: "20 g", collection: "hogar", model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
        'h-llaves': { name: "Colgador de llaves", image: "home keys.png", price: 16000, priceStr: "$16.000 COP", desc: "Soporte resistente para llaves. La fusión perfecta entre utilidad y diseño moderno.", size: "7.5 mm", material: "Filamento PLA", color: "Negro Matte", weight: "34 g", collection: "hogar", model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
        'h-ovejita': { name: "Soporte Ovejita Shaun", image: "shaun the sheep.png", price: 11000, priceStr: "$11.000 COP", desc: "Un toque de humor y orden para el baño. Soporte para papel higiénico que transforma lo cotidiano en algo memorable.", size: "19.1 mm", material: "Filamento PLA", color: "Negro Matte", weight: "11 g", collection: "hogar", model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
        'h-osito': { name: "Angel Osito", image: "angel osito.png", price: 18000, priceStr: "$18.000 COP", desc: "Un tierno osito con alas de ángel. Ideal para decorar habitaciones infantiles o como un detalle lleno de ternura.", size: "75 mm", material: "Filamento PLA", color: "Blanco (Pintado a mano)", weight: "22 g", collection: "hogar", model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
        'g-spiderman': { name: "Llavero Spiderman", image: "spiderman.png", price: 22000, priceStr: "$22.000 COP", desc: "Llavero inspirado en Spiderman. Un tributo pintado a mano.", size: "4 mm", material: "Filamento PLA", color: "Blanco (Pintado a mano)", weight: "5 g", collection: "geek", model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
  ...
  en: {
    ...
    products: {
      ...
      items: {
        't-carita': { name: "Happy Face Planter", image: "happy pot.png", price: 30000, priceStr: "$30,000 COP", desc: "Bring energy and style to your spaces with this planter, perfect for succulents and small plants.", size: "85 mm", material: "Biodegradable PLA Filament", color: "Tornasol (Iridescent)", weight: "124 g", collection: "tornasol", model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
        't-amigos': { name: "Friends Planter", image: "buddies.png", price: 27000, priceStr: "$27,000 COP", desc: "A balanced, two-tiered design, perfect for displaying complementary plants on your desk or in your study.", size: "85 mm", material: "Biodegradable PLA Filament", color: "Tornasol (Iridescent)", weight: "76 g", collection: "tornasol", model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
        't-ballenita': { name: "Whale Planter", image: "little whale.png", price: 28000, priceStr: "$28,000 COP", desc: "A plant pot inspired by marine life. A unique aesthetic touch.", size: "85 mm", material: "Biodegradable PLA Filament", color: "Tornasol (Iridescent)", weight: "116 g", collection: "tornasol", model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
        't-florero': { name: "Prism Vase", image: "vase.png", price: 36000, priceStr: "$36,000 COP", desc: "Parametric elegance. This vase transforms the atmosphere of any room.", size: "120 mm", material: "Biodegradable PLA Filament", color: "Tornasol (Iridescent)", weight: "144 g", collection: "tornasol", model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
        't-trex': { name: "T-Rex Pen Holder", image: "dinosaur.png", price: 27000, priceStr: "$27,000 COP", desc: "A pencil holder for your essentials. Keep your workspace tidy with a cute design.", size: "120 mm", material: "Biodegradable PLA Filament", color: "Tornasol (Iridescent)", weight: "76 g", collection: "tornasol", model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
        't-sardinas': { name: "Sardine Jewelry Box", image: "sardines.png", price: 21000, priceStr: "$21,000 COP", desc: "Protect and display your jewelry with a design inspired by tin cans.", size: "26 mm", material: "PLA Filament", color: "Tornasol and White", weight: "27 g", collection: "tornasol", model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
        'h-latas': { name: "Fridge Can Organizer", image: "can dispenser.jpg", price: 47000, priceStr: "$47,000 COP", desc: "Can dispenser designed to maximize storage space in your refrigerator.", size: "180 mm", material: "Premium PLA Filament", color: "White", weight: "260 g", collection: "hogar", model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
        'h-waffle': { name: "Waffle Bowl", image: "waffle bowl.png", price: 21000, priceStr: "$21,000 COP", desc: "A minimalist centerpiece or fruit bowl. Its lattice design adds striking visual contrast to any surface.", size: "10 mm", material: "Premium PLA Filament", color: "White", weight: "60 g", collection: "hogar", model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
        'h-angel': { name: "Angel Sculpture", image: "angel.png", price: 16000, priceStr: "$16,000 COP", desc: "A decorative figurine that brings protection and calm. Perfect for any corner of your home.", size: "85 mm", material: "PLA Filament", color: "White (Hand-painted)", weight: "20 g", collection: "hogar", model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
        'h-llaves': { name: "Minimal Key Holder", image: "home keys.png", price: 16000, priceStr: "$16,000 COP", desc: "Sturdy key holder. The perfect blend of functionality and modern design.", size: "7.5 mm", material: "PLA Filament", color: "Matte Black", weight: "34 g", collection: "hogar", model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
        'h-ovejita': { name: "Shaun the Sheep Holder", image: "shaun the sheep.png", price: 11000, priceStr: "$11,000 COP", desc: "A touch of humor and organization for the bathroom. A toilet paper holder that turns the everyday into something memorable.", size: "19.1 mm", material: "PLA Filament", color: "Matte Black", weight: "11 g", collection: "hogar", model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
        'h-osito': { name: "Angel Teddy Bear", image: "angel osito.png", price: 18000, priceStr: "$18,000 COP", desc: "A cute teddy bear with angel wings. Ideal for decorating children's rooms or as a gift full of tenderness.", size: "75 mm", material: "PLA Filament", color: "White (Hand-painted)", weight: "22 g", collection: "hogar", model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
        'g-spiderman': { name: "Spiderman Keychain", image: "spiderman.png", price: 22000, priceStr: "$22,000 COP", desc: "Spider-Man-inspired keychain. A hand-painted tribute.", size: "4 mm", material: "PLA Filament", color: "White (Hand-painted)", weight: "5 g", collection: "geek", model3d: "https://modelviewer.dev/shared-assets/models/Astronaut.glb" },
